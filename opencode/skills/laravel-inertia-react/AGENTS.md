...
**Priority**: CRITICAL to HIGH | **Rules**: 6
...
- Instant visits for immediate page rendering

**When to reference**: Implementing navigation, links, routing, programmatic page transitions, or optimizing perceived navigation speed.
...
| Instant page navigation | nav-instant-visits |
