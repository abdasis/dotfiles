...
> **IMPORTANT:** Default CLI runner: `bunx --bun shadcn@latest`. Substitute with `npx shadcn@latest` atau `pnpm dlx shadcn@latest` jika project menggunakan package manager lain.
